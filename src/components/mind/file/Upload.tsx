    ...
    <div className="bg-black rounded-xl p-4">
        <div className="flex text-white items-center justify-center">
            ...
            <div className="ml-auto flex items-center justify-center">
                <div className="flex items-center cursor-pointer items-center justify-content-center bg-white p-2 rounded-full text-black ">
                                                    ...
                                                    <DialogContent className="text-black bg-gray-200 border-none p-1 bg-gray-50 overflow-hidden overflow-x-auto overflow-y-auto scrollbar-hide">
                                                        ...
                                                        <div className="rounded-xl">
                                                            <object data={URL.createObjectURL(file)} type="application/pdf" width="100%" height="600px">
                                                                <p>Your browser does not support PDFs. <a href={URL.createObjectURL(file)}>View PDF</a>.</p>
                                                            </object>
                                                        </div>
                                                        </DialogDescription>

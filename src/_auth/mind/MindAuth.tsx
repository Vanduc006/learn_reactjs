            ...
            <div className="w-full max-w-md ">
                ...
                <Card className='p-5 w-[100%] mt-5'>
                    <CardHeader className='space-y-1'>
                        ...
                        <CardTitle className='text-2xl font-semibold'>SignIn & SignUp</CardTitle>
                        <CardDescription>Choose one of auth provider to continue</CardDescription>
                    </CardHeader>
                    <CardContent className=''>
                        <div className="flex space-x-2 ">
                            <button onClick={() => handleSocialSignIn("oauth_google")} className="pl-5 pr-5 pt-2 pb-2 bg-gray-200 rounded-xl hover:bg-gray-300 transition-transform  hover:scale-[1.02] flex items-center justify-content-center">
                            ...
                            <button onClick={() => handleSocialSignIn("oauth_apple")} className="pl-5 pr-5 pt-2 pb-2 bg-gray-200 rounded-xl hover:bg-gray-300 transition-transform  hover:scale-[1.02] flex items-center justify-content-center">
                            ...
                            <button onClick={() => handleSocialSignIn("oauth_facebook")} className="lg:block hidden lg:flex pl-5 pr-5 pt-2 pb-2 bg-gray-200 rounded-xl hover:bg-gray-300 transition-transform  hover:scale-[1.02] flex items-center justify-content-center">
                        ...
                        <div className='mt-2 lg:hidden block'>
                            <button onClick={() => handleSocialSignIn("oauth_facebook")} className="pl-5 pr-5 pt-2 pb-2 bg-gray-200 rounded-xl hover:bg-gray-300 transition-transform  hover:scale-[1.02] flex items-center justify-content-center">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128" className='w-5 h-5 mr-2'><rect fill="#3d5a98" x="4.83" y="4.83" width="118.35" height="118.35" rx="6.53" ry="6.53"/><path fill="#fff" d="M86.48 123.17V77.34h15.38l2.3-17.86H86.48v-11.4c0-5.17 1.44-8.7 8.85-8.7h9.46v-16A126.56 126.56 0 0091 22.7c-13.62 0-23 8.3-23 23.61v13.17H52.62v17.86H68v45.83z"/></svg>
                                Facebook
                            </button>
                        </div>

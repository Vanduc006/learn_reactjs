        ...
        <div className='min-h-screen w-full  h-screen overflow-x-hidden overflow-y-auto bg-slate-300 text-white block sm:hidden'>
            ...
            >
                ...
                {/* {cards.map((card, index) => (
                    ...
                    <CarouselItem>
                        <div className='bg-slate-200 ml-5 mr-5 h-[50%] rounded-xl p-2 overflow-y-auto text-black'>
                        <div className=' h-[50%] mt-5 rounded-xl overflow-y-auto'>
                            ...
                            <div id='user' className='w-[90%] ml-auto mb-5 bg-[#4871f7] p-2 rounded-xl drop-shadow-2xl'>
                                ...
                                <div id='user-media' className='flex flex-col gap-2 overflow-y-auto mt-2 overflow-hidden'>
